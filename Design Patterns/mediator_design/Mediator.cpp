...
Mediator: focus on interacting 2 collegues (ChatRoom, chess.com): 
    promote loose coupling, preventing them from referring to each other
Observer: state changes to observable (Notification)
