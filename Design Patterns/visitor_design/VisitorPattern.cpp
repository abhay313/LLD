...
/*
Double dispatch: 1 ref and 2 ref will decide which method will get executed

Strategy (no of behaviours (ops) will be constant but ways can be different) 
vs 
Visitor(no of ways constant but behaviours can be different)
