...
/*
Uses sharing to support large number of fine grained objects efficeintly
Intrinsic (Same - shared) and Extrinsic (supplied by client externally)

Use Cases:
- reduce mem usage (Ram)
- game similar objects (tree, human, cars etc - similar objects)
